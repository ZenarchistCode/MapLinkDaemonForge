#include "$CurrentDir:\\mpmissions\\dayzOffline.sakhal\\CustomObjects\\SpawnObject.c"
#include "$CurrentDir:\\mpmissions\\dayzOffline.sakhal\\CustomObjects\\CustomAreas.c"
